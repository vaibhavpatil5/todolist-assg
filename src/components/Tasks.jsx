    ...
    return (
        <div className="add-task-dialog">
            ...
            <div className="add-task-actions-container">
                ...
                <Button disabled={!task} className="add-btn" variant="contained" color="primary" onClick={() => { onAddTask(task, date); onCancel(); setTask(""); }}> Add Task</Button>
        
                    <Button className="cancel-btn" variant="outlined" color="secondary" onClick={() => { onCancel(); setTask(""); }}> Cancel</Button>
                </div>
    ...
    return (
        <div className="tasks">
            ...
            {selectedTab === "INBOX" ? (
                ...
                >
                    <span><Button className="add-task-text" color="primary"> + Add Task</Button></span>
                </div>
            ) : null}
            {showAddTask && (
                <AddTask
